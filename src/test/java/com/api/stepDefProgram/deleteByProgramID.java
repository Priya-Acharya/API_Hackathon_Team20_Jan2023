...
public class deleteByProgramID {
	...
	@When("User make a DELETE http request with resource as deletebyprogid slash {string}")
	public void user_make_a_delete_http_request_with_resource_as_deletebyprogid_slash(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
