...
public class DeleteByProgramName {
	...
	public void user_make_a_service_request_with_base_uri() {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}

	@When("User make a DELETE http request with resource as deletebyprogramName slash {string}")
	public void user_make_a_delete_http_request_with_resource_as_deletebyprogram_name_slash(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
