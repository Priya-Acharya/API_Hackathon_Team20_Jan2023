...
public class SaveProgram {
	...
	@Then("response body has {string}, {string}, {string}, {string}, {string}, {string}")
	public void response_body_has(String string, String string2, String string3, String string4, String string5, String string6) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
